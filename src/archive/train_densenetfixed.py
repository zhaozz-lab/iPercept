...
#
# tf.set_random_seed(6)  # ipercept1 2nd
# tf.set_random_seed(4)  # ipercept2 2nd
# tf.set_random_seed(5)  # ipercept3 2nd

tf.set_random_seed(7)  # ipercept1 3rd
tf.set_random_seed(8)  # ipercept2 3rd
tf.set_random_seed(9)  # ipercept3 3rd
